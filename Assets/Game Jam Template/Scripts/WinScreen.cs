...
public class WinScreen : MonoBehaviour {
	...
	void Awake() {
		...
		continueButt = WinPanel.Find ("ContinueButton").GetComponent<Button>();
	}
...
//					Debug.Log (temp);
					WinPanel.Find ("Winner Text").GetComponent<Text> ().text = ("Player " + (temp.controls.playerNum + 1) + " Wins!");
					WinPanel.Find ("Winner").GetComponent<Image> ().sprite = temp.playerIcon;

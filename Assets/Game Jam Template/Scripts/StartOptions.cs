...
public class StartOptions : MonoBehaviour {
	...
	void Awake() {
		...
		if (Instance) {
			...
			Transform charSelector = transform.Find ("MenuPanel").Find ("CharacterSelector");
			Transform charPreSelector = transform.Find ("MenuPanel").Find ("PreCharacterSelector");
			...
			startButton = transform.Find("MenuPanel").Find("MenuButtons").Find("Start").GetComponent<Button>();
